...
// Single, consistent icon family (Lucide-style, 24px grid, 1.75 stroke,
// currentColor). No emoji as icons anywhere in the app.
...
export function StarIcon({ filled, ...p }: IconProps & { filled?: boolean }) {
  return (
    <Svg {...p} fill={filled ? "currentColor" : "none"}>
      <path d="M12 2.5l2.9 5.9 6.5.95-4.7 4.58 1.11 6.47L12 17.9l-5.81 3.06 1.11-6.47L2.6 9.9l6.5-.95z" />
    </Svg>
  );
}
